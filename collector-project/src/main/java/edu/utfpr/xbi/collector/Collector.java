...
public class Collector {
    public static void main(String[] args) throws Exception {
        ...
        list.add(BrowserConfigurations.chromeWin("http://localhost:4444/wd/hub", header, -1));
        list.add(BrowserConfigurations.firefoxWin("http://localhost:4444/wd/hub", header, -1));
